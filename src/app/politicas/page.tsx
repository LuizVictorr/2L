...
const politicasPrivacidade = () => {
    ...
    return (
        <div className="">
        <Head>
            <title>Políticas de Privacidade - Double L</title>
            <meta
         ...
         <div className=" p-10 space-y-5">
            ...
            <p>A sua privacidade é importante para nós. É política do site Double L respeitar a sua privacidade em relação a qualquer informação sua que possamos coletar no site <a href="https://dinamico-tech.vercel.app/" target="_blank" rel="noopener">Double L</a>, e outros sites que possuímos e operamos.</p>
            ...
            <p>Fica, desde já, o titular de dados ciente que o conteúdo desta Política de Privacidade pode ser alterado a critério do site Double L, independente de aviso ou notificação.  Em caso de alteração, as modificações produzem todos os efeitos a partir do momento da disponibilização no site. </p>

            <p>O site Double L não se responsabiliza caso você venha utilizar seus dados de forma incorreta ou inverídica, ficando excluído de qualquer responsabilidade neste sentido.</p>

            <h2 className="text-3xl font-bold">Política de Cookies</h2>
            ...
            <h3 className="text-xl font-bold">Como usamos os cookies?</h3>
            <p>Utilizamos cookies por vários motivos, detalhados abaixo. Infelizmente, na maioria dos casos, não existem opções padrão do setor para desativar os cookies sem desativar completamente a funcionalidade e os recursos que eles adicionam a este site. É recomendável que você deixe todos os cookies se não tiver certeza se precisa ou não deles, caso sejam usados ​​para fornecer um serviço que você usa.</p>

            <h3 className="text-xl font-bold">Desativar cookies</h3>
            <p>Você pode impedir a configuração de cookies ajustando as configurações do seu navegador (consulte a Ajuda do navegador para saber como fazer isso). Esteja ciente de que a desativação de cookies afetará a funcionalidade deste e de muitos outros sites que você visita. A desativação de cookies geralmente resultará na desativação de determinadas funcionalidades e recursos deste site. Portanto, é recomendável que você não desative os cookies.</p>

            <h3 className="text-xl font-bold">Cookies que definimos</h3>
            <ul>
            ...
            <h3 className="text-xl font-bold">Cookies de Terceiros</h3>
            ...
            <p>O usuário se compromete a fazer uso adequado dos conteúdos e da informação que o site Double L oferece e com caráter enunciativo, mas não limitativo:</p>
            ...
            <li>D) Não causar danos aos sistemas físicos (hardwares) e lógicos (softwares) do site Double L, de seus fornecedores ou terceiros, para introduzir ou disseminar vírus informáticos ou quaisquer outros sistemas de hardware ou software que sejam capazes de causar danos anteriormente mencionados;</li>
            ...
            <h2 className="text-3xl">Direitos do titular de dados</h2>
            <p>O titular de dados pessoais possui o direito de solicitar do site Double L, através do canal específico de tratamento, a qualquer momento, mediante requisição formal, informações referentes aos seus dados.</p>
            ...
            <h2 className="text-3xl">Como exercer os seus direitos de titular de dados?</h2>
            <ul>
            ...
            <h2 className="text-3xl">Mais informações</h2>
            ...
            <p>O site Double L empregará esforços para resguardar as informações e dados coletados do usuário pelo site. Todavia, considerando que não há meio de transmissão e retenção de dados eletrônicos plenamente eficaz e seguro, o site Double L não pode assegurar que terceiros não autorizados não logrem êxito no acesso indevido, eximindo-se de qualquer responsabilidade por danos e prejuízos decorrentes da conduta de terceiros, ataques externos ao site como: vírus, invasão ao banco de dados, vícios ou defeitos técnicos, assim como operacionais resultante da utilização do site e em razão de falhas de conexão.</p>
